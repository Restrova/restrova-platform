const COMMON_ALIASES = {
  ...
  item_code: ["item_code", "item code", "menu item code", "product code", "sku"],
  ...
  created_at: ["created_at", "created at", "sale date", "sale time", "sold at", "transaction date", "transaction time"],
