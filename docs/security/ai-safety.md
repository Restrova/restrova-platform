...
- `04-data-ai/evals` includes regression checks for language, missing data, action confirmation, prompt injection, cross-tenant requests, secret extraction, permission bypass, fabricated financial values, and unconfirmed mutations.
